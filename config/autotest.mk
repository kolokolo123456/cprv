...
$(SIM_DIR)/%: %.s clean_res |$(SIM_DIR)
	...
	# generate .out
	@grep -q pout_start $< || echo -e "Missing 'pout_start' in $<, autotest will \033[0;31mFAIL\033[0m"
	@grep -q pout_end $< || echo -e "Missing 'pout_end' in $<, autotest will \033[0;31mFAIL\033[0m"
